...
var userInput = ""; // used to generate password based on criteria
var finalPassword = ""; //  used as a variable to store temporatly a random passoword.
var displayPassword = ""; // used to display the final password on the text area of the HTML element.
...
var pCriteria = {
 ...
 // Calling function to generate password criterias and adoption to our code
